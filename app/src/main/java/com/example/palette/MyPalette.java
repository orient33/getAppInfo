...
public class MyPalette {
    ...
    public static LauncherActivityInfo sLauncherActivityInfo;
    public static final int COLOR_DEFAULT = 0x80FFFFFF;

    public static ArrayList<Palette.Swatch> COLORES = new ArrayList<>(7);
...
//                0x8023c5a8, 0x805e43da, 0x80fac230, 0x80ff8900, 0x804a90e2, 0x80ef4848, 0x8046c14b
    ...
    public static int getColor(Bitmap bitmap, ArrayList<Palette.Swatch> listSwatch) {
        ...
        Collections.sort(listSwatch, new Comparator<Palette.Swatch>() {
            @Override
            public int compare(Palette.Swatch l, Palette.Swatch r) {
                return l.getPopulation() - r.getPopulation();
            }
        });
        ...
        Palette.PaletteAsyncListener listener = new Palette.PaletteAsyncListener() {
            ...
            public void onGenerated(Palette p) {
                ...
                if ((swatch = p.getVibrantSwatch()) != null) {
                    ...
                    Log.e("dd", "can not find a color ." + ((TextView) view).getText());
                }
